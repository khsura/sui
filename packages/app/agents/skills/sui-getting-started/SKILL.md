...
All form inputs share: `disabled`, `rules`, `hideDetails`, `error`, `dirty`, `label`.
...
| `SToggleButtonGroup` | Toggle button group (`v-model`, `multiple`) |
| `SToggleButton` | Toggle button (`value`) |
