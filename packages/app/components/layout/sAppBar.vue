...
import { SToolbar } from '~/components/toolbar'
import { getNumericCssAttribute, getWindow } from '~/lib'
import { propsAppBar } from '~/props'
import { useAppBarService } from '~/services'
