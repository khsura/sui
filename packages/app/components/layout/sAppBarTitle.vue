<template>
  <SToolbarTitle class="s_appBarTitle" v-bind="props">
...
import { SToolbarTitle } from '@/app/components/toolbar'
...
const props = useComponentDefaultsService('SAppBarTitle', rawProps)
</script>
