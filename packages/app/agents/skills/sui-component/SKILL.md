...
**SDialog, SMenu, STooltip, SSnackbar** all use `#activator`. Always bind BOTH `v-on` and `v-bind`:
...
Provide a complete, idiomatic example tailored to the user's specific use case.
