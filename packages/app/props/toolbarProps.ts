...
import { toolbarDensities } from '~/configs/toolbar'
import { defaultToolbarContentHeight, defaultToolbarExtensionHeight } from '~/constants/toolbar'
import { type ToolbarDensityType } from '~/types'
